// ╔══════════════════════════════════════════════════════════════════════════════╗
// ║  AURORA DEPTHS - Cursor Blaze Shader                                         ║
// ║  Cyberpunk Edition // 2026                                                   ║
// ║  "Every keystroke leaves a trace in the neural net"                          ║
// ╚══════════════════════════════════════════════════════════════════════════════╝
...
// ═══════════════════════════════════════════════════════════════════════════
// AURORA DEPTHS - Cyberpunk Edition Color Palette
// ═══════════════════════════════════════════════════════════════════════════
// Primary: purple (#c4b5f0)    → Neural glow, main trail
// Accent:  magenta (#e879a8)   → Synapse fire, outer edge
// Alt:     neoncyan (#00ffff)  → Electric pulse (optional)
// ═══════════════════════════════════════════════════════════════════════════

// Main trail color - Aurora purple (neural link glow)
const vec4 TRAIL_COLOR = vec4(0.769, 0.710, 0.941, 1.0);        // #c4b5f0

// Accent color - Aurora magenta (synapse fire edge)
const vec4 TRAIL_COLOR_ACCENT = vec4(0.910, 0.475, 0.659, 1.0); // #e879a8

// Animation timing
const float DURATION = 0.15; // Slightly faster for cyberpunk snap
