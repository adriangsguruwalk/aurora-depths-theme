// ╔══════════════════════════════════════════════════════════════════════════════╗
// ║  TOKYO NIGHT - Cursor Blaze Shader                                           ║
// ║  Based on folke/tokyonight.nvim - Night variant                              ║
// ║  "The neon lights of Tokyo at midnight"                                      ║
// ╚══════════════════════════════════════════════════════════════════════════════╝
...
// ═══════════════════════════════════════════════════════════════════════════
// Primary: blue (#7aa2f7)      → Vibrant neon glow, main trail
// Accent:  cyan (#7dcfff)      → Bright cyan, outer edge
// ═══════════════════════════════════════════════════════════════════════════

// Main trail color - Tokyo Night blue (vibrant neon glow)
const vec4 TRAIL_COLOR = vec4(0.478, 0.635, 0.969, 1.0);        // #7aa2f7

// Accent color - Tokyo Night cyan (bright outer edge)
const vec4 TRAIL_COLOR_ACCENT = vec4(0.490, 0.812, 1.0, 1.0);   // #7dcfff

// Animation timing
const float DURATION = 0.15; // Fast and fluid like city lights
