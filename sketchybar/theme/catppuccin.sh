#!/usr/bin/env bash
# # ──────────────────────────────────────────────────────────────────────────────
# # 🖼️ SketchyBar: Nord Theme
# # ──────────────────────────────────────────────────────────────────────────────
#
# # NORD COLOR PALETTE
# export _SSDF_CM_MAUVE=0xffb48ead  # Nord Purple
# export _SSDF_CM_RED=0xffbf616a    # Nord Red
# export _SSDF_CM_ORANGE=0xffd08770 # Nord Orange
# export _SSDF_CM_YELLOW=0xffebcb8b # Nord Yellow
# export _SSDF_CM_GREEN=0xffa3be8c  # Nord Green
# export _SSDF_CM_TEAL=0xff8fbcbb   # Nord Teal (Nord7)
# export _SSDF_CM_BLUE=0xff81a1c1   # Nord Blue (Nord9)
# export _SSDF_CM_FROST=0xff88c0d0  # Nord Frost (Nord8)
# export _SSDF_CM_PINK=0xffb48ead   # Nord Purple (same as mauve)
#
# # UI Colors
# export _SSDF_CM_SUBTEXT_1=0xffeceff4 # Nord Snow Storm (bright text)
# export _SSDF_CM_SUBTEXT_0=0xffd8dee9 # Nord Snow Storm (dimmed text)
# export _SSDF_CM_SURFACE_2=0xff4c566a # Nord Polar Night (Nord3)
# export _SSDF_CM_SURFACE_1=0xff3b4252 # Nord Polar Night (Nord1)
# export _SSDF_CM_SURFACE_0=0xff2e3440 # Nord Polar Night (Nord0)
#
# # Background colors
# export _SSDF_CM_MANTLE=0xdd191c22         # Darker background
# export _SSDF_CM_MANTLE_LIGHT=0xff1e2127   # Lighter background
# export _SSDF_CM_MANTLE_LIGHTER=0xff2e3440 # Lighter background
#
# # Workspace dot colors (using Nord accents)
# export _SSDF_WS_ORANGE=0xffd08770
# export _SSDF_WS_GREEN=0xffa3be8c
# export _SSDF_WS_CYAN=0xff88c0d0
# export _SSDF_WS_PURPLE=0xffb48ead
#
...
export _SSDF_CM_MAUVE=$_SSDF_CM_PURPLE
